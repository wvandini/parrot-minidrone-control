...
while(runcmd==1)
  ...
  switch (keybch)
  {
	  ...
	  case '8': x_ref += 0.2; break;
	  case '2': x_ref -= 0.2; break;
	  case '6': y_ref += 0.2; break;
	  case '4': y_ref -= 0.2; break;
	  ...
	  sprintf(sendBuff,"%i %i %i %i %i %i %i",runcmd,(int)(pitch_ref_RS*1000 + 10000),(int)(roll_ref_RS*1000 + 10000), (int)(yaw_ref*1000 + 10000), (int)(alt_ref*100.0), (int)(x_ref*100), (int)(y_ref*100));
